...
const passRegex=/^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#\$%\^&\*])(?=.{8,})/
   ...
   const postData=()=>{
    ...
    if(!emailRegex.test(email)){
        ...
        notifyA("Apassword must contain at least 8 characters,including at least 1 number and 1 includes both lower and uppercase letters and special characters for exampls #,?,!")
        return 
    }
    ...
    <div className='signUp'>
        <div className='form-container'>
            ...
            <div className='form2'>
                ...
                <Link to="/signin">
                <span style={{color:"#1773EA",cursor:"pointer"}}>Sign In</span>
            </Link>
                </div>
        </div>
    </div>
